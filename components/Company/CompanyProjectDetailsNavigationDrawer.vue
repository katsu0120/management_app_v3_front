  ...
  data () {
    return {
      ...
      navMenus: [
        ...
        { name: 'company-id-project-projectId-CompanyProjectDetails', icon: 'mdi-note-search-outline' },
        { name: 'company-id-project-projectId-CompletedTasks', icon: 'mdi-checkbox-marked-circle' },
