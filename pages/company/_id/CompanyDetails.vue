              ...
              >
                ...
                >
                  <v-card
                    ...
                    :height="card.height"
                    :elevation="card.elevation"
                    :to="{ name: 'company-id-project-projectId-CompanyProjectDetails', params: { id: currentCompany.id, projectId: project.id } }"
        ...
        >
          ...
          >
            ...
            <template #[`item.title`]="{ item }">
              <nuxt-link
                :to="{ name: 'company-id-project-projectId-CompanyProjectDetails', params: { id: currentCompany.id, projectId: item.id } }"
...
export default {
  ...
  methods: {
    ...
    success (response) {
      ...
      this.$router.push({ path: `/company/${companyId}/project/${projectId}/CompanyProjectDetails` })
      alert('新規作成されました')
    },
    createFailure (error) {
      console.log(error)
